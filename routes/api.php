...
Route::middleware(['auth:sanctum', 'customer'])
    ...
    Route::delete('reservations/clear-history',       [ReservationController::class, 'clearHistory']);
    ...
    Route::post('reservations/{reservasi}/process-payment', [ReservationController::class, 'processPayment'])
         ->where('reservasi', '[0-9]+');
    Route::post('reservations/{reservasiId}/auto-cancel',   [ReservationController::class, 'autoCancel'])
