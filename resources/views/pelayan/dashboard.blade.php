                ...
                <div class="col-lg-4">
                    ...
                    <div class="card shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3"> {{-- Cukup gunakan mb-3 untuk jarak antar elemen --}}
                            ...
                            <div class="mb-3"> {{-- Setiap input akan memiliki div pembungkusnya sendiri --}}
                    ...
                    <div class="card shadow-sm"> {{-- Tambahkan kelas card dan shadow-sm di sini --}}
                        <div class="card-header bg-light"> {{-- Ini adalah header card --}}
                            <h4 class="mb-0"><i class="bi bi-basket3-fill me-2"></i>Ringkasan Pesanan</h4>
                        </div>
                        <div class="card-body order-summary-card"> {{-- Pindahkan kelas order-summary-card ke card-body --}}
                            ...
                            <button type="submit" id="submitOrderBtn" class="btn btn-secondary w-100" disabled>Proses
                                Pesanan</button>
                        </div>
                    </div>
                    <div id="hiddenInputs">
